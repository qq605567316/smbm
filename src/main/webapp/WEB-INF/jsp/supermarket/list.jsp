                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">超市列表</div>
...
<form enctype="multipart/form-data">
    <div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">
        ...
        <div class="am-modal-dialog">
            <div class="am-modal-hd">新增超市信息:</div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">超市名称</label>
                <input type="text" class="am-modal-prompt-input" placeholder="超市名称" id="addsname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">超市地址</label>
                <input type="text" class="am-modal-prompt-input" placeholder="超市地址" id="addsaddress">
            </div>
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt2">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">修改超市信息:</div>
        <form enctype="multipart/form-data">
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">超市名称</label>
                <input type="text" class="am-modal-prompt-input" placeholder="超市名称" id="editsname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">超市地址</label>
                <input type="text" class="am-modal-prompt-input" placeholder="超市地址" id="editsaddress">
            </div>
            <div class="am-modal-footer">
                <span class="am-modal-btn" data-am-modal-cancel>取消</span>
                <span class="am-modal-btn" data-am-modal-confirm>提交</span>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">删除超市信息</div>
        <div class="am-modal-bd">
            确定要删除这条记录吗？
        </div>
        <div class="am-modal-bd">
            <input type="hidden" class="am-modal-prompt-input" placeholder="超市id" id="sid" value="">
        </div>
        <div class="am-modal-footer">
            <span class="am-modal-btn" data-am-modal-cancel>取消</span>
...
<script src="${path}/resources/js/supermarket/supermarketlist.js"></script>
<script src="${path}/resources/js/supermarket/supermarketadd.js"></script>
