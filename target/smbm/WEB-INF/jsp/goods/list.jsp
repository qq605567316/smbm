        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 商品管理 <small>Amaze UI</small></div>
                    <p class="page-header-description">Amaze UI 有许多不同的表格可用。</p>
                </div>
                <div class="am-u-lg-3 tpl-index-settings-button">
                    <button type="button" class="page-header-button" id="doc-prompt-toggle"><span class="am-icon-paint-brush"></span> 新增商品</button>
                </div>
            </div>
    ...
    <div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt">
        ...
        <div class="am-modal-dialog">
            ...
            <div class="am-modal-bd">
                ...
                <input type="file" id="addgpic">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品名称</label>
                <input type="text" class="am-modal-prompt-input" placeholder="商品名称" id="addgname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品数量</label>
                <input type="text" class="am-modal-prompt-input" placeholder="商品数量" id="addgnum">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品定价</label>
                <input type="number" class="am-modal-prompt-input" placeholder="商品定价" id="addgprice">
            </div>
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt2">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">修改商品信息:</div>
        <form enctype="multipart/form-data">
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品图片</label>
                <input type="file" id="editgpic"/>
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品名称</label>
                <input type="text" class="am-modal-prompt-input" placeholder="商品名称" id="editgname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品数量</label>
                <input type="text" class="am-modal-prompt-input" placeholder="商品描述" id="editgnum">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">商品定价</label>
                <input type="number" class="am-modal-prompt-input" placeholder="商品定价" id="editgprice">
            </div>
            <div class="am-modal-footer">
                <span class="am-modal-btn" data-am-modal-cancel>取消</span>
                <span class="am-modal-btn" data-am-modal-confirm>提交</span>
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <input type="hidden" class="am-modal-prompt-input" placeholder="商品定价" id="gid" value="">
        </div>
        <div class="am-modal-footer">
            <span class="am-modal-btn" data-am-modal-cancel>取消</span>
...
<script src="${path}/resources/js/goods/goodslist.js"></script>
<script src="${path}/resources/js/goods/goodsadd.js"></script>
