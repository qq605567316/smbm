        ...
        <div class="container-fluid am-cf">
            <div class="row">
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-9">
                    <div class="page-header-heading"><span class="am-icon-home page-header-heading-icon"></span> 管理员管理 <small>Amaze UI</small></div>
                    <p class="page-header-description">Amaze UI 有许多不同的表格可用。</p>
                </div>
                <div class="am-u-lg-3 tpl-index-settings-button">
                    <button type="button" class="page-header-button" onclick="editown(<%=manager.getMid()%>,'<%=manager.getMname()%>',
                        <%=manager.getMtel()%>,<%=manager.getPassword()%>)"><span class="am-icon-paint-brush"></span> 修改信息</button>
                </div>
                <%  if(manager.getLevel()==0){%>
                <div class="am-u-lg-3 tpl-index-settings-button">
                    <button type="button" class="page-header-button" onclick="window.location.href='/user/list'"><span class="am-icon-paper-plane"></span> 新增管理员</button>
                </div>
                <%}%>
            </div>
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt1">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">修改自己的信息:</div>
        <form enctype="multipart/form-data">
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">姓名</label>
                <input type="text" class="am-modal-prompt-input" placeholder="管理员姓名" id="mymname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">电话</label>
                <input type="number" class="am-modal-prompt-input" placeholder="管理员电话号码" id="mymtel">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">密码</label>
                <input type="text" class="am-modal-prompt-input" placeholder="管理员密码" id="mypassword">
            </div>
...
<div class="am-modal am-modal-prompt" tabindex="-1" id="my-prompt2">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">修改管理员信息:</div>
        <form enctype="multipart/form-data">
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">姓名</label>
                <input type="text" class="am-modal-prompt-input" placeholder="管理员姓名" id="editmname">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">电话</label>
                <input type="number" class="am-modal-prompt-input" placeholder="管理员电话号码" id="editmtel">
            </div>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">密码</label>
                <input type="text" class="am-modal-prompt-input" placeholder="管理员密码" id="editpassword">
            </div>

            <%if(manager.getLevel()==0){%>
            <div class="am-modal-bd">
                <label for="doc-ipt-3" class="am-u-sm-2 am-form-label">工资</label>
                <input type="number" class="am-modal-prompt-input" placeholder="管理员工资" id="editmsalary">
            </div>
            <div class="am-modal-bd">
...
<div class="am-modal am-modal-confirm" tabindex="-1" id="my-confirm">
    <div class="am-modal-dialog">
        <div class="am-modal-hd">删除管理员信息</div>
        <div class="am-modal-bd">
            确定要删除这条记录吗？
        </div>
        <div class="am-modal-bd">
            <input type="hidden" class="am-modal-prompt-input" placeholder="管理员id" id="mid" value="">
        </div>
        <div class="am-modal-footer">
            <span class="am-modal-btn" data-am-modal-cancel>取消</span>
...
<% if(manager.getLevel() == 0){%>
<script src="${path}/resources/js/manager/supermanagerlist.js"></script>
<%}else {%>
<script src="${path}/resources/js/manager/managerlist.js"></script>
<%}%>
